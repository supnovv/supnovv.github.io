...
* <text x="1em" y="25%" dy="1em">This SVG text won't wrap, so it will get cut off...</text>
...
* 最简单的是椭圆弧，它使用命令A或a绘制，其后跟７个参数：椭圆x和y轴半径，椭圆的x轴旋转角度，large-arc为1表示需要的圆弧的角度大于或等于180度，sweep表示需要的圆弧以正角度绘制，终点坐标（起点通过M指定）
