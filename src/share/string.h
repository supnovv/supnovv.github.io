...
typedef struct {
  ccmedit_uint m; /* string match this char */
  ccmedit_uint e; /* string end with this char */
} cccharinfo;
...
CORE_API ccstringmap ccstring_newmap(int maxstrlen, const ccnauty_char** str, int numofstr, int casesensitive);
CORE_API void ccstring_setmap(ccstringmap* self, const ccnauty_char** str, int numofstr, int casesensitive);
...
CORE_API const ccnauty_char* ccstring_skipspaceandmatchuntil(const ccstringmap* map, const void* s, int len, int* n);
